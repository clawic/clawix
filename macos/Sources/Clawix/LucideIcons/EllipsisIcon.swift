...
/// Lucide `ellipsis` glyph, ported 1:1 from the lucide-icons/lucide
...
struct EllipsisIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addEllipse(in: CGRect(x: 19 - 1, y: 12 - 1, width: 2 * 1, height: 2 * 1), transform: xform)
        path.addEllipse(in: CGRect(x: 5 - 1, y: 12 - 1, width: 2 * 1, height: 2 * 1), transform: xform)
        return path
    }
}
