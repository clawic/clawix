...
#
# Examples:
#   bash apps/macos/scripts/perf-capture.sh --template "os_signpost" --name sidebar-lag
#   bash apps/macos/scripts/perf-capture.sh --template "Animation Hitches" --duration 30
#   bash apps/macos/scripts/perf-capture.sh --template "Allocations" --name long-session
#
...
# 3) Resolve trace output directory. Slot under apps/macos/artifacts/
...
See apps/macos/PERF.md for the symptom-to-template mapping and what
