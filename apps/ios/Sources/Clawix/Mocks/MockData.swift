...
// Sample state used by SwiftUI #Preview macros and by the empty
// PairingView placeholder. Mirrors the macOS sample chats so the
// iPhone preview feels familiar.
