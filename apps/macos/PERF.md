...
2. Run the capture for that template:
   ```
   bash apps/macos/scripts/perf-capture.sh --template "<template>" --name <slug>
   ```
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "SwiftUI" --name sidebar`.
- Look at: `apps/macos/Sources/Clawix/SidebarView.swift:145`.
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "Animation Hitches" --name chat-scroll`.
- Look at: `apps/macos/Sources/Clawix/ChatView.swift:43` (the LazyVStack)
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "Allocations" --name long-session`.
- Look at: `apps/macos/Sources/Clawix/AppState.swift:42, 614, 3465-3584`
  and `apps/macos/Sources/Clawix/ChatView.swift:850`.
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "Time Profiler" --name freeze`.
- Look at: `apps/macos/Sources/Clawix/AgentBackend/ClawixClient.swift:241`
  (decode), `apps/macos/Sources/Clawix/ChatView.swift:490-523`
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "os_signpost" --name streaming`.
- Look at: `apps/macos/Sources/Clawix/StreamingFade.swift` and the
...
- Capture: `bash apps/macos/scripts/perf-capture.sh --template "Time Profiler" --name idle-cpu`.
