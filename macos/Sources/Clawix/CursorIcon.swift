...
/// sizes. Solid fill: an arrow-shaped quadrilateral (tip top-left, two
/// tail corners and one inward concave notch on the back diagonal),
/// every corner rounded with a quadratic curve so the silhouette stays
/// soft at small point sizes.
